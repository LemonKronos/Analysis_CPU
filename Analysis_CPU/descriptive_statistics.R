...
# Lưu biểu đồ 1A
ggsave(filename = "Histogram_Price.png", plot = p_hist_price, width = 8, height = 5, dpi = 300)
...
# Lưu biểu đồ 1B
ggsave(filename = "Histogram_TDP.png", plot = p_hist_tdp, width = 8, height = 5, dpi = 300)
...
# Lưu biểu đồ 2
ggsave(filename = "Boxplot_Segment.png", plot = p_box, width = 8, height = 6, dpi = 300)