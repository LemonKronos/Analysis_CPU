...
# Lưu bảng
library(gridExtra)
png("inferential_statistic_2_3/figure/Summary_Result_Table.png", width = 500, height = 200, res = 120)
grid.table(result)
dev.off()
...
# Lưu và đóng file
dev.copy(png, filename = "inferential_statistic_2_3/figure/QQ_Plots_Comparison.png", width = 1200, height = 600, res = 150)
dev.off()
